#ifndef __COMMAND_FILE_READER_V2_H__
#define __COMMAND_FILE_READER_V2_H__
...
typedef struct command_info_st
{
	...
	int16_t score;  				//!threshold of score.
...
extern uint32_t cmd_file_get_max_command_number();

extern uint32_t cmd_file_get_max_special_word_number();

extern uint32_t cmd_file_get_max_cmd_string_table_size();
