...
extern void vPortAsmAssertSP(void);
...
//#define portYIELD() ECALL(PORT_YIELD); //请求切换任务，会进入trap_entry函数，定义在portasm.S
#define portYIELD() port_MSIPSET_BIT;    //请求切换任务，相当于arm cortex m的PendSVC，会触发软中断函数，定义在portasm.S
